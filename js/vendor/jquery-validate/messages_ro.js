! function(e) {
	...
	return e.extend(e.validator.messages, {
		...
		maxlength: e.validator.format("Vă rugăm să nu introduceți mai mult de {0} caractere."),
		min: e.validator.format("Vă rugăm să introduceți o valoare mai mare sau egală cu {0}."),
		minWords: e.validator.format("Vă rugăm să introduceți cel puțin {0} cuvinte."),
		minlength: e.validator.format("Vă rugăm să introduceți cel puțin {0} caractere."),
		notEqualTo: "Vă rugăm să introduceți o valoare diferită, valorile nu trebuie să fie identice.",
		nowhitespace: "Vă rugăm să nu introduceți spații goale.",
