! function(e) {
	...
	return e.extend(e.validator.messages, {
		...
		maxlength: e.validator.format("Non inserire più di {0} caratteri"),
		min: e.validator.format("Inserisci un valore maggiore o uguale a {0}"),
		minWords: e.validator.format("Si prega di inserire almeno {0} parole."),
		minlength: e.validator.format("Inserisci almeno {0} caratteri"),
		notEqualTo: "Si prega di inserire un valore diverso, i valori non devono essere uguali.",
		nowhitespace: "Si prega di non inserire spazi bianchi.",
