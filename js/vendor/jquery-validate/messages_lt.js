! function(e) {
	...
	return e.extend(e.validator.messages, {
		...
		maxlength: e.validator.format("Prašau įvesti ne daugiau kaip {0} simbolių."),
		min: e.validator.format("Prašau įvesti reikšmę didesnę arba lygią {0}."),
		minWords: e.validator.format("Prašau įvesti bent {0} žodžių."),
		minlength: e.validator.format("Prašau įvesti bent {0} simbolius."),
		notEqualTo: "Prašau įvesti kitą reikšmę, reikšmės negali būti vienodos.",
		nowhitespace: "Prašau neįvesti tarpų.",
