! function(e) {
	...
	return e.extend(e.validator.messages, {
		...
		maxlength: e.validator.format("Proszę o podanie nie więcej niż {0} znaków."),
		min: e.validator.format("Proszę o podanie wartości większej bądź równej {0}."),
		minWords: e.validator.format("Proszę wpisać co najmniej {0} słów."),
		minlength: e.validator.format("Proszę o podanie przynajmniej {0} znaków."),
		notEqualTo: "Proszę wpisać inną wartość, wartości nie mogą być takie same.",
		nowhitespace: "Proszę nie wpisywać spacji.",
