! function(e) {
	...
	return e.extend(e.validator.messages, {
		...
		maxlength: e.validator.format("Por favor, forneça não mais que {0} caracteres."),
		min: e.validator.format("Por favor, forneça um valor maior ou igual a {0}."),
		minWords: e.validator.format("Por favor, forneça pelo menos {0} palavras."),
		minlength: e.validator.format("Por favor, forneça ao menos {0} caracteres."),
		notEqualTo: "Por favor, forneça um valor diferente, os valores não podem ser iguais.",
		nowhitespace: "Por favor, não use espaços em branco.",
