! function(e) {
	...
	return e.extend(e.validator.messages, {
		...
		domain: "Veuillez fournir un nom de domaine valide.",
		...
		maxlength: e.validator.format("Veuillez fournir au plus {0} caract\xe8res."),
		min: e.validator.format("Veuillez fournir une valeur sup\xe9rieure ou \xe9gale \xe0 {0}."),
		minWords: e.validator.format("Veuillez fournir au moins {0} mots."),
		minlength: e.validator.format("Veuillez fournir au moins {0} caract\xe8res."),
